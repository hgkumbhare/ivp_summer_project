 ...
 * @author hgkumbhare
 * 
 * This class takes image in a mapper and blurs the image and reducer writes the image on local
 * 
 */
public class IntraFrame extends Configured implements Tool {
	...
	public void map(HipiImageHeader key, FloatImage value, Context context)
	    ...
	    // call blurs image function here
	...
	public void reduce(IntWritable key, Iterable<FloatImage> values,
		...
		// Convert FloatImage to BufferedImage to save to local disk
		...
		// output directory needs to be mentioned here
		String outputdir = "/home/hduser/";
		ImageIO.write(bufferedImage, "jpg", new File(outputdir
	...
	System.out.println("TIME TAKEN TO EXECUTE " + totalTime);
	System.exit(0);
    }
